...
public class ArenaController {
    ...
    @Autowired
    public ArenaController(ArenaService service) { this.service = service; }

    @GetMapping
    public ResponseEntity<List<Arena>> findAll() { return new ResponseEntity<>(service.findAll(), HttpStatus.OK); }
